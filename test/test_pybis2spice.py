...
class TestPybis2Spice(unittest.TestCase):
    ...
    def test_extract_range_param(self):
        ...
        self.assertEqual(dm.extract_range_param(model.pullup_reference), None)
    ...
    def test_increasing(self):
        self.assertEqual(dm.increasing([0, 0, 0, 0]), True)
        self.assertEqual(dm.increasing([0, 1, 0, 0]), False)
        self.assertEqual(dm.increasing([0, 1, 2, 3]), True)
        self.assertEqual(dm.increasing([0, 1, 1, 39000]), True)
    ...
    def test_get_reference(self):
        ...
        self.assertEqual(dm.get_reference(ref1, v_range, 1), 3)
        self.assertEqual(dm.get_reference(ref1, v_range, 2), 3.3)
        self.assertEqual(dm.get_reference(ref1, v_range, 3), 3.6)

        # Test when the ref parameter is None. The output should be equal to the v_range
        self.assertEqual(dm.get_reference(ref2, v_range, 1), 4.5)
        self.assertEqual(dm.get_reference(ref2, v_range, 2), 5)
        self.assertEqual(dm.get_reference(ref2, v_range, 3), 5.5)
