...
def generate_spice_model_file(
    ...
    ----------
        io_type 
            "Input" or "Output" or "Tri-State"
        subcircuit_type 
            "LTSpice" or "Generic"
        ibis_data 
            a DataModel object (defined in pybis2spice.py)
        corner 
            "WeakSlow" or "Typical" or "FastStrong"
        output_filepath 
            path of output file
        truncation 
            the percentage of the total range to use to truncate trailing samples in rising and falling waveforms
